...
int BExp::accept(ImpVisitor* v) {
  return v->visit(this);
}

// int TrueExp::accept(ImpVisitor* v) {
//   return v->visit(this);
// }

// int FalseExp::accept(ImpVisitor* v) {
//   return v->visit(this);
// }
...
ImpType BExp::accept(TypeVisitor* v) {
  return v->visit(this);
}

// ImpType TrueExp::accept(TypeVisitor* v) {
//   return v->visit(this);
// }

// ImpType FalseExp::accept(TypeVisitor* v) {
//   return v->visit(this);
// }
...
ForStatement::ForStatement(string var, Exp* start, Exp* end, Body* b): varName(var), startExp(start), endExp(end), body(b) {}
...
ForStatement::~ForStatement(){delete startExp; delete endExp; delete body;}
